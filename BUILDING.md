...
- Se `./gradlew` falhar por indisponibilidade de rede/proxy ao baixar a distribuição, `./tools/gradle_with_jdk21.sh` faz fallback automático para `gradle` já instalado no host.
